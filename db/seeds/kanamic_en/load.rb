...
save_node route: "uploader/file", name: "Common", filename: "common"
...
save_page route: "cms/page", filename: "index.html", name: "System for Elderly Care / Elderly Care Software｜Kanamic Network", layout_id: layouts["index"].id